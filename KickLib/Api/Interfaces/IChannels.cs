...
public interface IChannels
{
    ...
    /// </summary>
    Task<Result<ChannelResponse>> GetChannelAsync(int broadcasterUserId, string? accessToken = null, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result<ICollection<ChannelResponse>>> GetChannelsAsync(ICollection<int> broadcasterUserIds, string? accessToken = null, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result<ChannelResponse>> GetChannelAsync(string slug, string? accessToken = null, CancellationToken cancellationToken = default);
    ...
    /// </summary>
    Task<Result<ICollection<ChannelResponse>>> GetChannelsAsync(ICollection<string> slugs, string? accessToken = null, CancellationToken cancellationToken = default);

    /// <summary>
    ///     Retrieve channel information for the currently authorised user.
    /// </summary>
    Task<Result<ChannelResponse>> GetMyChannelAsync(string? accessToken = null, CancellationToken cancellationToken = default);

    /// <summary>
    ///     Update channel information.
    /// </summary>
    Task<Result<bool>> UpdateChannelAsync(UpdateChannelRequest request, string? accessToken = null, CancellationToken cancellationToken = default);
}
